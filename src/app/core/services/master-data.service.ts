...
export class MasterDataService {
  ...
  getClasses(): Observable<ClassDto[]> {
    return this.http.get<ApiResponse<ClassDto[]>>(`${this.apiUrl}/classes`).pipe(
  ...
  getSectionsByClass(classId: number | string): Observable<SectionDto[]> {
    return this.http.get<ApiResponse<SectionDto[]>>(
  ...
  getSubjectsByClass(classId: number | string): Observable<SubjectDto[]> {
    return this.http.get<ApiResponse<SubjectDto[]>>(
  ...
  getExamTypesByClass(classId: number | string): Observable<ExamTypeDto[]> {
    return this.http.get<ApiResponse<ExamTypeDto[]>>(
  ...
  getAllSections(): Observable<SectionDto[]> {
    return this.http.get<ApiResponse<SectionDto[]>>(`${this.apiUrl}/sections`).pipe(
      map(response => response.data || []),
      catchError(error => {
  ...
  getAllSubjects(): Observable<SubjectDto[]> {
    return this.http.get<ApiResponse<SubjectDto[]>>(`${this.apiUrl}/subjects`).pipe(
      map(response => response.data || []),
      catchError(error => {
  ...
  getAllExamTypes(): Observable<ExamTypeDto[]> {
    return this.http.get<ApiResponse<ExamTypeDto[]>>(`${this.apiUrl}/exam-types`).pipe(
      map(response => response.data || []),
      catchError(error => {
